...
//   IMPLEMENTAÇÃO:
//
//   INSERÇÃO DO NOVO CÓDIGO DE CONTROLE DO MOTOR DE PASSO
//
//
//============================================================================================================================
...
// Rótulos das pinagens
  ...
  #define     Btn_Liga_MP      22          // Botão para ligar o motor de passo (pino 18)
  #define     Btn_Para_MP      23          // Botão de parada do motor de passo (pino 19)
  #define     Btn_Avanca_MP    24          // Botão de avanço do motor de passo (pino 21)
  #define     Btn_Recua_MP     25          // Botão de recuo do motor de passo (pino 20)
  #define     enable_MP        26          // Habilita o driver do motor de passo (pino 24)
  #define     dir_MP           27          // Define a direçao do motor de passo (pino 25)
  ...
  #define     CFC_Início       39          // Chave fim de curso início
  #define     CFC_Fim          41         //  Chave fim de curso fim
